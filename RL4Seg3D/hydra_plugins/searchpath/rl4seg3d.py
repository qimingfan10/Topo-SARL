...
class RL4Seg3DSearchPathPlugin(SearchPathPlugin):  # noqa: D101
    def manipulate_search_path(self, search_path: ConfigSearchPath) -> None:  # noqa: D102
        ...
        search_path.append(provider="rl4seg3d-searchpath-plugin", path="pkg://rl4seg3d.config")
        search_path.append(provider="rl4seg3d-searchpath-plugin", path="pkg://configs")
