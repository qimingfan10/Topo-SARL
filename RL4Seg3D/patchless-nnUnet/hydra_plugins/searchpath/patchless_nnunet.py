...
class PatchlessnnUnetSearchPathPlugin(SearchPathPlugin):  # noqa: D101
    def manipulate_search_path(self, search_path: ConfigSearchPath) -> None:  # noqa: D102
        ...
        search_path.append(provider="patchless_nnunet-searchpath-plugin", path="pkg://patchless_nnunet.configs")
